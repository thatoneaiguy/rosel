...
public class KilnScreenHandler extends ScreenHandler {
	...
	public KilnScreenHandler(int syncId, PlayerInventory inventory) {
		this(syncId, inventory, new SimpleInventory(3), new ArrayPropertyDelegate(2));
	}

	public KilnScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
		super(BismuthimiteScreenHandlers.KILN_SCREEN_HANDLER, syncId);
