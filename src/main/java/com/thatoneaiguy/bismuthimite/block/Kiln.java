package com.thatoneaiguy.bismuthimite.block;
...
public class Kiln extends BlockWithEntity implements BlockEntityProvider {
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		return checkType(type, BismuthimiteBlockEntities.KILN, KilnBlockEntity::tick);
	}
}
